...
import { PayerUpdatedProcessor } from './processors';
...
@Module({
  ...
  providers: [NftItemService, UserService, Web3Service, PayerUpdatedProcessor],
})
export class PayerUpdatedQueueModule {}
