...
# Data directory
DB1_DATA_DIR="/data/db/mongo1"
DB2_DATA_DIR="/data/db/mongo2"
DB3_DATA_DIR="/data/db/mongo3"

# Log directory
DB1_LOG_DIR="/data/log/mongodb1"
DB2_LOG_DIR="/data/log/mongodb2"
DB3_LOG_DIR="/data/log/mongodb3"
